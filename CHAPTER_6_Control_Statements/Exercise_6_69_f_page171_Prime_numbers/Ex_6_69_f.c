...
int main(int argc, char *argv[]) {
	...
	for(i=2; i<=x; ++i) { //NOTE: we start with 2, not with 1, because 1 is not considered a prime number
...
****************************************  starting a new loop (incrementing i == 3)  (n set to zero, j set to 1)  ************************************
...
****************************************  starting a new loop (incrementing i == 4)  (n set to zero, j set to 1)  ************************************
